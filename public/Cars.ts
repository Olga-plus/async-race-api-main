...
export class Car {
    ...
    step(timestamp: number) {
        ...
        if (this.evtType === 'started'){
            ...
            console.log ( progresstime , 'd!prog', this.timestamp, '<this.timestamp', timestamp, '< timestamp', this.start)
            ...
            let windoWidth =  ((document.body.scrollWidth - this.car.getBoundingClientRect().width) * progresstime) / timestamp; //--&
